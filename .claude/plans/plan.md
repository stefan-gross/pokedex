...
| Scanner — Rahmenerkennung | Zwei-Stufen-Erkennung: 1) Varianz-Check (Objekt vorhanden?), 2) 4-Kanten-Check via `countCardEdges()` (45% Video-Ausschnitt, Gradient an 4 Kartenrändern); Rahmen: weiß=nichts, orange=1-2 Kanten, gelb=3-4 Kanten (Karte), grün=Snap; 4 Punkte-Indikator bei orange | `components/scanner/CameraCapture.tsx` |
